 ...
 * eeprom_stm32f0.h
 *
 * Shared STM32F0 flash driver body (save_flash_nolib / read_flash_bin),
 * halfword programming, erase-by-address via FLASH->AR.
 *
 * #included at the end of Mcu/{f031,f051}/Src/eeprom.c. Not a standalone
 * translation unit.
 */
