...
#define SET_AND_ENABLE_COM_INT(time)            (COM_TIMER->cval = 0,COM_TIMER->pr = time,COM_TIMER->ists = 0x00,COM_TIMER->iden |= TMR_OVF_INT)
...
#define SET_DUTY_CYCLE_ALL(newdc)               (TMR1->c1dt = newdc,TMR1->c2dt = newdc,TMR1->c3dt = newdc)
