...
//	if (step == 1 || step == 4) {   // c floating
//#ifdef INVERTED_COMP
//		COMP2->CSR = (((((COMP2->CSR))) & (~((0xFUL << (4U)) | (0x3UL << (8U))))) | (COMP_COMMON | PHASE_C_COMP));
//#else
//		COMP2->CSR = (((((COMP2->CSR))) & (~((0xFUL << (4U)) | (0x3UL << (8U))))) | (PHASE_C_COMP | LL_COMP_INPUT_PLUS_IO3));
//#endif
//	}

//	if (step == 2 || step == 5) {     // a floating
//#ifdef INVERTED_COMP
//		COMP2->CSR = (((((COMP2->CSR))) & (~((0xFUL << (4U)) | (0x3UL << (8U))))) | (COMP_COMMON | PHASE_A_COMP));
//#else
//		COMP2->CSR = (((((COMP2->CSR))) & (~((0xFUL << (4U)) | (0x3UL << (8U))))) | (PHASE_A_COMP | LL_COMP_INPUT_PLUS_IO3));
//#endif
...
//	if (step == 3 || step == 6) {      // b floating
//#ifdef INVERTED_COMP
//		COMP2->CSR = (((((COMP2->CSR))) & (~((0xFUL << (4U)) | (0x3UL << (8U))))) | (COMP_COMMON | PHASE_B_COMP));
//#else
//		COMP2->CSR = (((((COMP2->CSR))) & (~((0xFUL << (4U)) | (0x3UL << (8U))))) | (PHASE_B_COMP | LL_COMP_INPUT_PLUS_IO3));
//#endif
