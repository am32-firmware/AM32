...
//        SET_PRESCALER_PWM(50); // frequency of beep
//        delayMillis(200); // duration of beep

//        comStep(5);
//        SET_PRESCALER_PWM(36); // next beep is higher frequency
//        delayMillis(200);

//        comStep(6);
//        SET_PRESCALER_PWM(24); // higher again..
//        delayMillis(200);
...
//    SET_AUTO_RELOAD_PWM(TIM1_AUTORELOAD);
//    RELOAD_WATCHDOG_COUNTER();
//    SET_PRESCALER_PWM(58);
//    setCaptureCompare();
//    comStep(3);
//    delayMillis(150);
//	  pause(25);
//	  RELOAD_WATCHDOG_COUNTER();
//    SET_PRESCALER_PWM(32);
//    delayMillis(250);
//    allOff();
//    SET_PRESCALER_PWM(0);
//    signaltimeout = 0;
