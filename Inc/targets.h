...
#define AUX_SPI_SCK_PORT GPIOA
#define AUX_SPI_SCK_PIN 0
#define AUX_SPI_SCK_AF 5

#define AUX_SPI_NSS_PORT GPIOA
#define AUX_SPI_NSS_PIN 0
#define AUX_SPI_NSS_AF 5

#define AUX_SPI_MISO_PORT GPIOA
#define AUX_SPI_MISO_PIN 0
#define AUX_SPI_MISO_AF 5

#define AUX_SPI_MOSI_PORT GPIOA
#define AUX_SPI_MOSI_PIN 0
...
#define GATE_DRIVER_SPI_MISO_EXTRA1_PORT GPIOE
#define GATE_DRIVER_SPI_MISO_EXTRA1_PIN 3

#define GATE_DRIVER_SPI_MISO_EXTRA2_PORT GPIOE
#define GATE_DRIVER_SPI_MISO_EXTRA2_PIN 6

#define GATE_DRIVER_SPI_MISO_EXTRA3_PORT GPIOE
#define GATE_DRIVER_SPI_MISO_EXTRA3_PIN 5

#define GATE_DRIVER_SPI_MISO_EXTRA4_PORT GPIOE
#define GATE_DRIVER_SPI_MISO_EXTRA4_PIN 4

#define GATE_DRIVER_SPI_MISO_EXTRA5_PORT GPIOE
#define GATE_DRIVER_SPI_MISO_EXTRA5_PIN 2

#define GATE_DRIVER_SPI_MISO_EXTRA6_PORT GPIOD
#define GATE_DRIVER_SPI_MISO_EXTRA6_PIN 3

#define GATE_DRIVER_SPI_MISO_EXTRA7_PORT GPIOD
#define GATE_DRIVER_SPI_MISO_EXTRA7_PIN 4

#define GATE_DRIVER_SPI_MISO_EXTRA8_PORT GPIOD
#define GATE_DRIVER_SPI_MISO_EXTRA8_PIN 5

#define GATE_DRIVER_SPI_MISO_EXTRA9_PORT GPIOD
#define GATE_DRIVER_SPI_MISO_EXTRA9_PIN 6

#define GATE_DRIVER_SPI_MISO_EXTRA10_PORT GPIOD
#define GATE_DRIVER_SPI_MISO_EXTRA10_PIN 7
...
#define PHASEA_CURRENT_ADC_CHANNEL 6
...
#define PHASEB_CURRENT_ADC_CHANNEL 3
...
#define PHASEC_CURRENT_ADC_CHANNEL 6
...
// is not configured in alternate function mode!
// see also https://community.st.com/t5/stm32-mcus-products/stm32h7a3-spi-not-working-if-sck-disabled/td-p/201817
#define LED_SPI_SCK_PORT GPIOD
#define LED_SPI_SCK_PIN 3
#define LED_SPI_SCK_AF 5

#define LED_SPI_PERIPH SPI2
#define LED_AM32_SPI_PERIPH SPI_2
#define LED_SPI_ENABLE_CLOCK() { \
...
// GPIO E0
// GPIO E4
#define DEBUG_GPIO1_PORT MAIN_P1_PORT
#define DEBUG_GPIO1_PIN MAIN_P1_PIN
...
// GPIO B6
// GPIO E6
#define DEBUG_GPIO2_PORT MAIN_P2_PORT
#define DEBUG_GPIO2_PIN MAIN_P2_PIN
...
// GPIO B7
// GPIO E5
#define DEBUG_GPIO3_PORT MAIN_P3_PORT
#define DEBUG_GPIO3_PIN MAIN_P3_PIN
...
#define AUX_USART_TX_DMA_REQ LL_GPDMA1_REQUEST_USART1_TX
...
#define MAIN_USART_BAUDRATE 1000000
#define MAIN_USART_RX_DMA_REQ LL_GPDMA1_REQUEST_UART4_RX
#define MAIN_USART_TX_DMA_REQ LL_GPDMA1_REQUEST_UART4_TX
#define MAIN_USART_ENABLE_CLOCK() { \
    LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_UART4); \
}
